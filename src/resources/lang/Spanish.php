...
En el ejemplo anterior, el sistema reemplazará %name% con los datos de la columna Nombre. Debes tener la columna Nombre en tu archivo de Excel para que funcione.',
    ...
    'support' => 'Soporte',
    'faqs_link' => 'Puedes encontrar preguntas frecuentes en <a target="_blank" href="https://app.looksms.com/docs">este enlace</a>.',
    'support_link' => 'Si las preguntas frecuentes no resuelven el problema que estás experimentando, puedes abrir un ticket de soporte en <a target="_blank" href="https://app.looksms.com/support">este enlace</a>.',
    'cron_job_instructions' => 'Agrega una tarea cron ejecutando el siguiente comando en la terminal de Linux. Si estás utilizando Cpanel o Vesta Panel, sigue una guía en <a target="_blank" href="https://app.looksms.com/docs">este enlace</a> para configurar una tarea cron.',
...
&quot;¡{Hi|Hola|Hey} %name%, ¿cómo estás?&quot;',
    ...
    'sim' => 'SIM',
    'error_no_sim_present' => 'No hay una tarjeta SIM en la ranura %slot%. Reinicia la aplicación LookSMS en tu dispositivo Android si has insertado la tarjeta SIM recientemente.',
