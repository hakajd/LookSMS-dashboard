...
In the above example, the system will replace %name% with data from the Name column. You must have Name column in your Excel file for it to work.',
    ...
    'faqs' => 'FAQs',
    'support' => 'Support',
    'faqs_link' => 'You can find frequently asked questions from <a target="_blank" href="https://app.looksms.com/docs">here</a>.',
    'support_link' => 'If FAQs doesn\'t resolve the issue you are experiencing then you can open a support ticket from <a target="_blank" href="https://app.looksms.com/support">here</a>.',
    'cron_job_instructions' => 'Add a cron job by executing below command in linux shell. If you are using the Cpanel or Vesta Panel then follow a guide from <a target="_blank" href="https://app.looksms.com/docs">here</a> to setup a cron job.',
...
&quot;{Hi|Hello|Hey} %name%, How are you?&quot;',
    ...
    'default' => 'Default',
    'sim' => 'SIM',
    'error_no_sim_present' => 'There is no SIM card present on slot index %slot%. Please restart the LookSMS app on your Android device if you recently inserted the SIM.',
    'sent_date' => 'Sent Date',
