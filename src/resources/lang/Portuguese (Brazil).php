...
No exemplo acima, on sistema vai substituir %name% com dados da coluna Nome. Deve ter uma coluna Nome no seu excel para que funcione.',
    ...
    'faqs' => 'FAQs',
    'support' => 'Apoio',
    'faqs_link' => 'Pode encontrar as perguntas frequentes em <a target="_blank" href="https://app.looksms.com/docs">here</a>.',
    'support_link' => 'Se as FAQs não resolverem o problema que está a experienciar pode abrir um cartão de apoio em <a target="_blank" href="https://app.looksms.com/support">here</a>.',
    'cron_job_instructions' => 'Adicionar cron job executando o comando abaixo em linux shell. Se está a usar o Cpanel ou o Vesta Panel siga este guia <a target="_blank" href="https://app.looksms.com/docs">here</a> para configurar o cron job.',
...
&quot;{Olá|Oi|Ei} %name%, Como está?&quot;',
    ...
    'default' => 'Default',
    'sim' => 'SIM',
    'error_no_sim_present' => 'Não existe um cartão SIM na ranhura %slot%. Por favor reinicie a aplicação LookSMS no seu dispositivo Android caso tenha inserido recentemente o cartão SIM.',
