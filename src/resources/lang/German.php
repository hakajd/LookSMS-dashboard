...
Im obigen Beispiel ersetzt das System %name% durch Daten aus der Spalte Name. Sie müssen die Spalte Name in Ihrer Excel-Datei haben, damit dies funktioniert.',
    ...
    'debug' => 'Debuggen',
    'username' => 'Nutzername',
    'application_copyright' => '<strong>Copyright &copy; 2018-%present% <a href="https://app.looksms.com">LookSMS</a></strong>. Alle Rechte vorbehalten.',
    ...
    'faqs_link' => '<a target="_blank" href="https://app.looksms.com/docs">Hier</a> finden Sie häufig gestellte Fragen.',
    'support_link' => 'Wenn FAQs das aufgetretene Problem nicht beheben, können Sie von <a target="_blank" href="https://app.looksms.com/support">hier</a> aus ein Support-Ticket öffnen.',
    'cron_job_instructions' => 'Fügen Sie einen Cron-Job hinzu, indem Sie den folgenden Befehl in der Linux-Shell ausführen. Wenn Sie das Cpanel- oder Vesta-Panel verwenden, befolgen Sie eine Anleitung von <a target="_blank" href="https://app.looksms.com/docs">hier</a> aus, um einen Cron-Job einzurichten.',
...
&quot;{Hallo|Hi|Hey} %name%, Wie geht es Ihnen?&quot;',
    ...
    'default' => 'Standard',
    'sim' => 'SIM',
    'error_no_sim_present' => 'Auf dem Steckplatzindex %slot% ist keine SIM-Karte vorhanden. Bitte starten Sie die LookSMS-App auf Ihrem Android-Gerät neu, wenn Sie kürzlich die SIM-Karte eingelegt haben.',
